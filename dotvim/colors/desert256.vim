...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    "tayo:editing background color to be more gray, adding CursorLine shading
    "call <SID>X("Normal", "cccccc", "000000", "")
    call <SID>X("Normal", "f8f8f5", "333333", "")
    call <SID>X("CursorLine", "", "2a2a2a", "none")
    """""""""""""""""""""""""""""
    ...
    call <SID>X("NonText", "addbe7", "181818", "bold")
