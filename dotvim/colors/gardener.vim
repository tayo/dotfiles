...
" Colors for the User Interface.
    ...
    "tayo:added custom CursorLine shading
    exec "hi CursorLine     cterm=NONE   ctermfg=NONE  ctermbg=235"

    "tayo:making background lighter
    "exec hi Normal         cterm=NONE   ctermfg=255   ctermbg=233
    exec "hi Normal         cterm=NONE   ctermfg=255   ctermbg=234"
    
    "tayo:change color of non-text EOF region
